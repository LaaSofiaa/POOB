...
public class DataTest {
    ...
    @Test
    public void shouldKnowWhenTwoHaveTypes () {
        assertEquals(new Data("TRUE").type(),'b');
        assertEquals(new Data("false").type(),'b');
        assertEquals(new Data("DATA").type(),'b');
        
        assertEquals(new Data("87").type(),'n');
        assertEquals(new Data("45.66").type(),'n');
        
        assertEquals(new Data("a").type(),'c');
        assertEquals(new Data("G").type(),'c');
    }
}